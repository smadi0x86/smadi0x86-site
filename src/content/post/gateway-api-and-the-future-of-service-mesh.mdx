...
The convergence of ingress and service mesh configuration under a single, expressive, and official Kubernetes API is a watershed moment for the ecosystem. It promises:
